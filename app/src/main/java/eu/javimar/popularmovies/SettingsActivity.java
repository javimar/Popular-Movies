...
public class SettingsActivity extends AppCompatActivity
{
            ...
            implements Preference.OnPreferenceChangeListener
    {
        ...
        public void onCreate(Bundle savedInstanceState)
        {
            ...
            //  set this fragment as the OnPreferenceChangeListener and update the
        ...
        public boolean onPreferenceChange(Preference preference, Object value)
        {
            ...
            // Since this is the first ListPreference that the fragment is encountering,
            // update the onPreferenceChange() method to properly update the summary of
            // a ListPreference (using the label, instead of the key)
        ...
        /* set the current EarhtquakePreferenceFragment instance as the listener on
